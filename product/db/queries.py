...
CREATE_STATE = """
INSERT INTO availconf.alert_state (
    insight_id,
    short_name,
    full_name,
    trigger_name,
...
APPEND_AUDIT_EVENT = """
INSERT INTO availconf.alert_state_audit (
    alert_state_id,
    insight_id,
    event_value,
    event_time,
...
INSERT INTO availconf.alert_incidents (
    insight_id,
    short_name,
    full_name,
    trigger_name,
...
UPDATE availconf.alert_incidents
SET closed_at = NOW(),
