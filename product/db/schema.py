...
CREATE TABLE IF NOT EXISTS availconf.alert_state (
...
CREATE INDEX IF NOT EXISTS ix_alert_state_insight_id_created_at
    ON availconf.alert_state (insight_id, created_at DESC);

CREATE INDEX IF NOT EXISTS ix_alert_state_insight_id_status
    ON availconf.alert_state (insight_id, status);
"""

ALERT_STATE_AUDIT_SCHEMA_SQL = """
CREATE TABLE IF NOT EXISTS availconf.alert_state_audit (
    id BIGSERIAL PRIMARY KEY,
...
ALTER TABLE availconf.alert_state_audit
...
CREATE TABLE IF NOT EXISTS availconf.alert_incidents (
    id BIGSERIAL PRIMARY KEY,
    insight_id TEXT NOT NULL,
    short_name TEXT,
    full_name TEXT,
...
CREATE TABLE IF NOT EXISTS availconf.ad_ktalk_user_map (
